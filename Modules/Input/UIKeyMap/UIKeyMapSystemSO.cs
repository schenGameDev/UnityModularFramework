...
using static ModularFramework.Modules.Input.InputSystemSO;
...
namespace ModularFramework.Modules.Input
{
    ...
    public class UIKeyMapSystemSO : GameSystem<UIKeyMapSystemSO>, IRegistrySO, ILive
    {
        ...
        [SerializeField, DataTable, ShowField(nameof(IsInputAsset))]
        private ActionKeyPair[] inputs;

        [SerializeField, DataTable, ShowField(nameof(IsInputAsset))]
        private KeyIcon[] icons;
