...
namespace ModularFramework.Modules.Camera
{
    ...
    public class CameraManagerSO : GameModule<CameraManagerSO>, IRegistrySO
    {
        ...
        public void CameraTransitionToDefault(CameraTransitionType transitionType) =>
            CameraTransitionTo(_defaultCamera, transitionType);
        ...
        {
            return camera.TryGetComponent<CameraBase>(out var cam) && cam.Ready;
        }
        ...
        private bool UpdatePlayerCameraPosition()
        {
            ...
            playerScreenPosition =
                SingletonRegistry<GameBuilder>.Instance.MainCamera.WorldToScreenPoint(player.transform.position);
            return true;
        }
