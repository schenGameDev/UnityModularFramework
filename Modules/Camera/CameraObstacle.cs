...
namespace ModularFramework.Modules.Camera
{
    public class CameraObstacle : MonoBehaviour
    {
        ...
        [SerializeField,
         MessageBox("Alpha is not in use when transparent material is set", nameof(_replaceMat), MessageMode.Log)]
        ...
        [SerializeField,
         MessageBox("If Empty, change existing material Transparency", nameof(_alterExistingMat), MessageMode.Log)]
        ...
        private void Start()
        {
            _mainCam = SingletonRegistry<GameBuilder>.Instance.MainCamera.transform;
