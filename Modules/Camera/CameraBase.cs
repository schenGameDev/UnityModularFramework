...
namespace ModularFramework.Modules.Camera
{
    ...
    public abstract class CameraBase : MonoBehaviour, IMark, IReady
    {
        ...
        async UniTaskVoid CameraShakeTask(Transform core, Vector2 positionOffsetStrength, float rotationOffsetStrength,
