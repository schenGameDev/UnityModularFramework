...
namespace ModularFramework.Modules.Ability
{
    public class ProjectileManagerSO : GameModule<ProjectileManagerSO>
    {
        ...
        private void HandleCollisions()
        {
            ...
            {
                _raycastBatchProcessor.PerformSpherecasts(sphereOrigins, sphereDirections, sphereRadii,
                    collisionMask.value, false,
                    false, false, hits => OnRaycastResults(hits, sphereIndices, ref hitResults));
            }

            if (boxOrigins.Length > 0)
            {
                _raycastBatchProcessor.PerformBoxcasts(boxOrigins, boxDirections, boxHalfExtents, boxRotations,
                    collisionMask.value,
            ...
            {
                _raycastBatchProcessor.PerformCapsulecasts(capsulePointA, capsulePointB, capsuleDirections,
                    capsuleRadii, collisionMask.value,
